    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card dashboard-card h-100">
                    <div class="card-body text-center p-4">
                        <a href="views/beneficiario/beneficiarios.php"
                            class="btn btn-dashboard btn-beneficiarios w-100">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card dashboard-card h-100">
                    <div class="card-body text-center p-4">
                        <a href="views/contratos/contratos.php" class="btn btn-dashboard btn-contratos w-100">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card dashboard-card h-100">
                    <div class="card-body text-center p-4">
                        <a href="views/pagos/pagos.php" class="btn btn-dashboard btn-pagos w-100">
